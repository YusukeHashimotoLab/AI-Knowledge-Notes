---
title: "Chapter 2: Statistical Process Control (SPC) and Control Charts"
chapter_title: "Chapter 2: Statistical Process Control (SPC) and Control Charts"
subtitle: Practical methods for visualizing process variation and early anomaly detection
---

[AI Terakoya Home](<../index.html>)›[Process Informatics](<../../index.html>)›[QA](<../../PI/qa-introduction/index.html>)›Chapter 2

🌐 EN | [🇯🇵 JP](<../../../jp/PI/qa-introduction/chapter-2.html>) | Last sync: 2025-11-16
...
A control chart consists of the following elements:
  ...
  * **Center Line (CL)** : Indicates the process average
  * **Upper Control Limit (UCL)** : Average + 3σ
  * **Lower Control Limit (LCL)** : Average - 3σ
  * **Data Points** : Process measurements along the time series
...
### Basic Understanding
  ...
  * ✅ Explain the purpose of SPC and the difference between common cause and special cause variation
  * ✅ Understand the basic structure of control charts (CL, UCL, LCL) and the rationale for the 3σ rule
  * ✅ Select between variable control charts (X-bar/R, EWMA, CUSUM) and attribute control charts (P, C)
  * ✅ Clearly explain the difference between control limits and specification limits

### Practical Skills

  * ✅ Implement X-bar and R charts and evaluate process stability
  * ✅ Manage defect rates and defect counts using P-charts and C-charts
  * ✅ Implement CUSUM and EWMA for early detection of small mean shifts (0.5-2σ)
  * ✅ Apply Western Electric Rules to detect anomalies from data patterns
  * ✅ Integrate control charts with process capability analysis for comprehensive evaluation
  * ✅ Build real-time monitoring systems

### Application Capabilities

  * ✅ Select optimal control chart methods according to process characteristics
  * ✅ Adjust balance between sensitivity and specificity by combining multiple control charts
  * ✅ Understand trade-offs between detection delay and Type I/Type II errors, and set parameters
  * ✅ Address implementation challenges in manufacturing (sampling frequency, automation, alert fatigue)
...
[← Series Index](<./index.html>) [Chapter 3: Six Sigma and DMAIC →](<chapter-3.html>)
