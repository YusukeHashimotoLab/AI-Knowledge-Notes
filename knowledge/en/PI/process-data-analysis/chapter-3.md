---
title: "Chapter 3: Anomaly Detection and Fault Diagnosis"
chapter_title: "Chapter 3: Anomaly Detection and Fault Diagnosis"
subtitle: Anomaly Detection and Fault Diagnosis for Process Systems
---

[AI Terakoya Top](<../index.html>)›[Process Informatics](<../../index.html>)›[Process Data Analysis](<../../PI/process-data-analysis/index.html>)›Chapter 3

🌐 EN | [🇯🇵 JP](<../../../jp/PI/process-data-analysis/chapter-3.html>) | Last sync: 2025-11-16
...
Design and implement a practical anomaly detection system that meets the following requirements: 
  ...
  1. Primary screening with statistical methods (reduce computational cost)
  2. Detailed inspection with machine learning for suspicious data
  3. Estimate causes with Granger causality when anomalies are detected
  4. Set thresholds to keep false alarm rate below 5%
