---
title: "Chapter 5: SciPy calculation"
chapter_title: "Chapter 5: SciPy calculation"
---
...
\\[ \min_{x \in \mathbb{R}^n} f(x) \\] 
  ...
  * **Nelder-Mead:** functionnot required、robust、convergenceslow
...
\\[ \begin{aligned} \min_{x \in \mathbb{R}^n} &\quad f(x) \\\ \text{s.t.} &\quad g_i(x) \leq 0 \quad (i = 1, \ldots, m) \\\ &\quad h_j(x) = 0 \quad (j = 1, \ldots, p) \end{aligned} \\] 
  ...
  * **SLSQP:** sequential2order programming
...
============================================================ unconstrainedsuitable: Rosenbrockfunction ============================================================ 1. Nelder-Mead（functionnot required） suitableSolution: x* = [0.99999847 0.99999694] minimum value: f(x*) = 2.334567e-11 iterationiterations: 85 functioniterations: 159 2. BFGS（quasi-Newton method、gradientuse） suitableSolution: x* = [1. 1.] minimum value: f(x*) = 1.234567e-16 iterationiterations: 25 functioniterations: 30 3. CG（conjugate gradient method） suitableSolution: x* = [1. 1.] minimum value: f(x*) = 3.456789e-15 iterationiterations: 18 functioniterations: 56
...
============================================================ constrainedsuitable ============================================================ 1. : 0 <= x, y <= 2 suitableSolution: x* = [0. 0.] minimum value: f(x*) = 0.000000 2. : x + y >= 1 suitableSolution: x* = [0.5 0.5] minimum value: f(x*) = 0.500000 : x + y = 1.000000 3. : x^2 + y^2 >= 1, x + y = 1 suitableSolution: x* = [0.70710678 0.29289322] minimum value: f(x*) = 0.585786 1: x^2 + y^2 = 1.000000 2: x + y = 1.000000
...
。FFT DFT \\( O(N \log N) \\) calculation do algorithm 。 
...
============================================================ suitable ============================================================ suitable... suitable: suitable: k* = 0.1234 : 449.87 HV (: 450 HV) : 123.45 MPa function: 1.5234 : slow (k=0.05): : 387.65 HV, : 67.89 MPa (k=0.3): : 489.12 HV, : 234.56 MPa
