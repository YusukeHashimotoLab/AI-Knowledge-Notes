---
title: "Chapter 5: Crystal Structure Visualization with Python"
chapter_title: "Chapter 5: Crystal Structure Visualization with Python"
subtitle: Utilizing pymatgen Library and Materials Project
...
As a basic pymatgen operation, we will create a simple cubic lattice.
    ...
    print(f"\nLattice volume: {lattice.volume:.4f} Å³")
    ...
    print(f"Lattice volume: {structure_fcc.volume:.4f} Å³")
...
CIF files can be downloaded for free from [Crystallography Open Database (COD)](<https://www.crystallography.net/cod/>) and [Materials Project](<https://materialsproject.org/>).
...
Load a crystal structure from a CIF file and display detailed information.
    ...
    print(f"Lattice volume: {lattice.volume:.4f} Å³")
    ...
    print(f"Primitive cell volume: {primitive.volume:.4f} Å³")
    
    # Get conventional cell
    conventional = sga.get_conventional_standard_structure()
    print(f"\nNumber of atoms in conventional cell: {conventional.num_sites}")
    print(f"Conventional cell volume: {conventional.volume:.4f} Å³")
...
To use the Materials Project API, create an account at [Materials Project](<https://materialsproject.org/>) and obtain an API key (free).
...
**Solution** :
  ...
  1. Create account at [Materials Project](<https://materialsproject.org/>)
  2. Obtain API key
