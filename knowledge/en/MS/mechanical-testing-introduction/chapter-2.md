---
title: "Chapter 2: Hardness and Impact Testing"
chapter_title: "Chapter 2: Hardness and Impact Testing"
subtitle: Indentation and Dynamic Loading Methods
---

🌐 EN | 日本語 (準備中) Last sync: 2025-11-16

[Materials Science Dojo](<../index.html>) > [Mechanical Testing Introduction](<index.html>) > Chapter 2 
...
### 💻 Code Example 1: Hardness Calculation
...
Hardness correlates with tensile strength. For steels, UTS (MPa) ≈ 3.45 × HB. 

### 💻 Code Example 2: Hardness-Strength Conversion
...
### 💻 Code Example 3: Impact Energy Calculation
...
### 💻 Code Example 5: Oliver-Pharr Analysis
...
### 💻 Code Example 6: Hardness Mapping
...
### 💻 Code Example 7: Statistical Hardness Analysis
    ...
    print(f"Mean Hardness: {results['mean']:.1f} ± {results['std']:.1f} HV")
...
**✏️ Exercises**
  ...
  3. Determine impact energy absorbed in Charpy test with 140° initial and 50° final angles.
  4. Analyze DBTT curve and predict impact energy at -40°C.
...
## Summary
  ...
  * Hardness correlates with tensile strength (UTS ≈ 3.45 × HB for steel)
...
[← Chapter 1: Tensile Testing](<chapter-1.html>) [Chapter 3: Creep Testing →](<chapter-3.html>)
