---
title: "第1章: 熱力学の基本法則と熱力学ポテンシャル"
chapter_title: "第1章: 熱力学の基本法則と熱力学ポテンシャル"
---

🌐 JP | [🇬🇧 EN](<../../../en/FM/equilibrium-thermodynamics/chapter-1.html>) | Last sync: 2025-11-16

[基礎数理道場](<../index.html>) > [平衡熱力学と相転移](<index.html>) > 第1章 
...
熱力学ポテンシャル間の変換は**Legendre変換** で与えられます。
...
## 📚 まとめ
  ...
  * **熱力学の4つの法則** は、温度の定義、エネルギー保存、エントロピー増大、絶対零度の性質を規定
  * **内部エネルギー U** は基本的な状態関数で、第一法則 \\(dU = \delta Q - \delta W\\) に従う
  * **エンタルピー H** は等圧過程で有用で、化学反応熱の計算に使われる
  * **Helmholtz自由エネルギー F** は等温過程での有用仕事を与え、統計力学と直結
  * **Gibbs自由エネルギー G** は等温等圧条件で最重要で、化学平衡・相平衡の判定基準
  * ポテンシャル間の関係は**Legendre変換** で結ばれる
  * **熱力学第3法則** により、低温でエントロピーと比熱がゼロに近づく（\\(T^3\\) 依存）
...
[← シリーズTOP](<index.html>) [第2章: Maxwell関係式と熱力学的関係 →](<chapter-2.html>)
