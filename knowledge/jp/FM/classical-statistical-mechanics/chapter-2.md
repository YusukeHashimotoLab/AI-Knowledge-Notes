---
title: "第2章: カノニカル集団と分配関数"
chapter_title: "第2章: カノニカル集団と分配関数"
---

🌐 JP | [🇬🇧 EN](<../../../en/FM/classical-statistical-mechanics/chapter-2.html>) | Last sync: 2025-11-16

[基礎数理道場](<../index.html>) > [古典統計力学入門](<index.html>) > 第2章 
...
これが有名な**Debye \\(T^3\\) 則** です。実験とよく一致します。
...
## 📚 まとめ
  ...
  * **カノニカル集団** は温度固定の系を記述し、分配関数 \\(Z\\) から全熱力学量が導出可能
  * **Helmholtz自由エネルギー** \\(F = -k_B T \ln Z\\) が基本的な熱力学ポテンシャル
  * **等分配定理** により、古典的な2次エネルギー項は各自由度で \\(\frac{1}{2}k_B T\\) のエネルギーを持つ
  * **調和振動子** は量子効果（零点エネルギー）と高温古典極限を示す基本系
  * **2準位系** はSchottky比熱を示し、磁性やトンネル系のモデル
  * **Einstein固体** は独立振動子の集合としてDulong-Petitの法則を説明
  * **Debyeモデル** は低温で \\(T^3\\) 則を与え、実験とよく一致
  * 理想気体の分配関数は**並進・回転・振動に分離** でき、各寄与を独立に評価可能
  * **非調和効果** が熱膨張の起源であり、Grüneisenパラメータで特徴づけられる
...
[← 第1章: 統計力学の基礎と確率論](<chapter-1.html>) [第3章: グランドカノニカル集団 →](<chapter-3.html>)
