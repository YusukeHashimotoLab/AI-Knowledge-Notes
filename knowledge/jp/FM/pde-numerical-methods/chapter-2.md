---
title: "第2章: Crank-Nicolson法と安定性解析"
chapter_title: "第2章: Crank-Nicolson法と安定性解析"
---

## 学習目標

  * Crank-Nicolson法と安定性解析の基本概念と理論的枠組みを理解する
  * 数学的定式化とアルゴリズムを習得する
  * Pythonによる実装方法を学ぶ
  * 材料科学・物理学への応用例を理解する
...
材料科学または物理学の具体的な問題を選び、Crank-Nicolson法と安定性解析の手法を 適用してシミュレーションせよ。結果を解析し、物理的解釈を与えなさい。 

## まとめ

  * Crank-Nicolson法と安定性解析の理論的基礎と数学的定式化を学んだ
