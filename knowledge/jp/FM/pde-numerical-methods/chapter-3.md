---
title: "第3章: 有限要素法の基礎"
chapter_title: "第3章: 有限要素法の基礎"
---

## 学習目標

  * 有限要素法の基礎の基本概念と理論的枠組みを理解する
  * 数学的定式化とアルゴリズムを習得する
  * Pythonによる実装方法を学ぶ
  * 材料科学・物理学への応用例を理解する
...
材料科学または物理学の具体的な問題を選び、有限要素法の基礎の手法を 適用してシミュレーションせよ。結果を解析し、物理的解釈を与えなさい。 

## まとめ

  * 有限要素法の基礎の理論的基礎と数学的定式化を学んだ
...
[前へ](<chapter-2.html>) [目次](<index.html>) 次へ（準備中）
