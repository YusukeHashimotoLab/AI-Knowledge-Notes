...
prerequisites:
  - "第1章・第2章の内容理解"
  - "Pythonプログラミング経験"
  - "NumPy, Pandas, scikit-learn, TensorFlow基礎"
learning_objectives:
  basic:
    - "Materials Projectから電池材料データを取得できる"
    - "XGBoostで容量予測モデルを構築できる"
  practical:
    - "LSTMでサイクル劣化を予測できる"
    - "ベイズ最適化で最適材料を探索できる"
    - "PyBaMMで電池シミュレーションを実行できる"
  advanced:
    - "DFT-ML連携ワークフローを実装できる"
    - "多目的最適化で性能とコストをバランスできる"
keywords:
  - "PyBaMM"
  - "XGBoost"
  - "LSTM"
...
1. Sulzer, V. et al. "Python Battery Mathematical Modelling (PyBaMM)." *JOSS* (2021).
2. Severson, K. A. et al. "Data-driven prediction of battery cycle life." *Nat. Energy* (2019).
3. Chen, C. et al. "A Critical Review of Machine Learning of Energy Materials." *Adv. Energy Mater.* (2020).
4. Attia, P. M. et al. "Closed-loop optimization of fast-charging protocols." *Nature* (2020).

---

**次章**: [第4章：電池開発の最新事例と産業応用](chapter4-case-studies.md)
