...
<div class="video-container">
  <iframe
    ...
    title="電池材料設計へのMI応用 第3章: Pythonで実装する電池MI実践ハンズオン"
...
### 例3: 電位プロファイル計算
    ...
    print(f"活物質の比エネルギー: {energy_density:.3f} Wh/g")
    

**レベルの違いに注意:** ここで得られる値は正極活物質のみの比エネルギーです。200 mAh/gの材料を平均3.45 Vで使う場合は約0.69 Wh/g（690 Wh/kg）になります。実際のセルには負極・電解質・セパレータ・集電体・外装も含まれるため、セルレベルのエネルギー密度はこの約3分の1、第1章で示した200-300 Wh/kgの水準になります。
