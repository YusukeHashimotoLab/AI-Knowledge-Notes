---
title: 電池材料設計へのMI応用シリーズ v1.0
chapter_title: 電池材料設計へのMI応用シリーズ v1.0
---

🌐 JP | [🇬🇧 EN](<../../../en/MI/battery-mi-application/index.html>) | Last sync: 2025-11-16

[AI寺子屋トップ](<../../index.html>)›[マテリアルズ・インフォマティクス](<../index.html>)›Battery Mi Application
...
\- 影響：プロトタイプセルで約400-500 Wh/kgを実証（量産品ではまだ達成されていません）
...
\- 論文：Attia et al., _Nature_ (2020) **Case Study 4: Co削減型正極材料 - Ni比率最適化**

\- 課題：Co価格の高さと変動（2022年ピークで約$40,000/ton）、および供給リスク

\- 戦略：Ni比率増加（NCM811, NCM90-05-05）
...
**A** : このシリーズは「入門から中級」を対象としています。専門家レベルに達するには：
  ...
  * このシリーズで基礎を固める（2-4週間）
  * 論文精読（ _Nature Energy_ , _Advanced Energy Materials_ ）（3-6ヶ月）
  * 独自プロジェクト実行（6-12ヶ月）
  * 学会発表や論文執筆（1-2年）
...
**Immediate（1-2週間）:**
  * ✅ GitHubにポートフォリオ作成
  * ✅ プロジェクトチャレンジの結果を公開
  * ✅ LinkedInに「Computational Battery Science」スキル追加
**Short-term（1-3ヶ月）:**
  * ✅ Materials Projectのデータで独自プロジェクト
  * ✅ 第4章の参考文献から3本精読
  * ✅ PyBaMMコミュニティに参加
**Medium-term（3-6ヶ月）:**
  * ✅ 論文10本精読（ _J. Electrochem. Soc._ , _ACS Energy Lett._ ）
  * ✅ オープンソースプロジェクトにコントリビュート
  * ✅ 国内学会で発表（電気化学会、応用物理学会）
**Long-term（1年以上）:**
  * ✅ 国際学会（ECS Meeting, MRS）で発表
  * ✅ 査読付き論文投稿
  * ✅ 電池関連の仕事に就く（電池メーカー or EV企業）
