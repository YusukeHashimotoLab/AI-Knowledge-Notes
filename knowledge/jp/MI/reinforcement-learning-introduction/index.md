...
### 論文
  ...
  1. Zhou et al. "Deep reinforcement learning for materials discovery" _Nature Communications_ (2021)
  2. Noh et al. "Inverse design of solid-state materials via a continuous representation" _Matter_ (2019)
  3. Segler et al. "Planning chemical syntheses with deep neural networks and symbolic AI" _Nature_ (2018)
