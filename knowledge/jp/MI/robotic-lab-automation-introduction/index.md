...
### 必須知識
  ...
  * **ベイズ最適化基礎** : ガウス過程、獲得関数の基本概念（[ベイズ最適化・アクティブラーニング入門](<../bayesian-optimization-introduction/>)を推奨）
...
### [第1章: 材料実験自動化の必要性と現状](<./chapter-1.html>)
...
### [第2章: ロボティクス実験の基礎](<./chapter-2.html>)
...
### [第3章: クローズドループ最適化](<./chapter-3.html>)
...
### [第4章: クラウドラボと遠隔実験](<./chapter-4.html>)
...
### 前提シリーズ（推奨）
  ...
  * **[ベイズ最適化・アクティブラーニング入門](<../bayesian-optimization-introduction/>)** : クローズドループ最適化の理論基盤
...
### 発展的シリーズ
  ...
  * **[実験データ解析入門](<../experimental-data-analysis-introduction/>)** : 自動取得データの高度な解析

### 並行学習推奨

  * **[ハイスループット計算入門](<../high-throughput-computing-introduction/>)** : 計算と実験の融合
  * **[材料データベース活用入門](<../materials-databases-introduction/>)** : 実験データの構造化と共有
...
**著者** : 橋本佑介（東北大学） **作成日** : 2025年10月17日 **更新日** : 2025年10月17日
