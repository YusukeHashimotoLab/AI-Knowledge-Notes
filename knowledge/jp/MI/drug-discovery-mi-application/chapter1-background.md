...
<div class="video-container">
  <iframe
    ...
    title="創薬・医薬品開発へのMI応用 第1章: 創薬とマテリアルズ・インフォマティクスの役割"
    frameborder="0"
...
**最終成功率** : 0.000006%（100万 → 0.06、すなわち1億化合物あたり約6件の承認に相当します）
...
**AI創薬市場の急成長**（市場調査会社による概算で、出典により幅があります） : \- **2020年代前半** : 約$1B \- **2020年代半ば** : 約$4-5B（推定） \- **2030年代前半** : $15-25B程度と予測 \- 年平均成長率: 採用する推計により概ね30-40%
...
**開発期間短縮** : \- 従来: 10-15年 \- AI活用: 3-5年（60-70%削減） \- 実例: \- Exscientia（OCD薬DSP-1181）: 候補化合物まで12ヶ月（従来4.5年、73%短縮）。ただしこの候補は2021年にPhase I後に開発中止となりました \- Insilico Medicine（IPF薬）: 18ヶ月（従来3-5年、70%短縮）
...
**Exscientia（英国、Oxford）** : \- 設立: 2012年 \- 資金調達: $525M（IPO 2021、時価総額$2.4B） \- パイプライン: 30+化合物（内3つPhase I/II） \- パートナー: Sanofi, Bayer, BMS \- 現況: 2024年11月にRecursion Pharmaceuticalsと統合しました（上記の数値は独立企業だった当時のものです）
...
**BenevolentAI（英国、London）** : \- 設立: 2013年 \- 資金調達: $292M \- 技術: Knowledge Graph, NLP \- 実績: Drug repurposing（ALS, COVID-19） \- 現況: 2025年に事業を縮小し上場廃止となりました（歴史的な事例として掲載しています）
...
**QSAR（定量的構造活性相関）の誕生** : \- **1962年** : Hansch & Fujita、最初のQSAR式発表 `log(1/C) = a * logP + b * σ + c * Es + d` \- C: 生物活性濃度 \- logP: 分配係数（脂溶性） \- σ: Hammett定数（電子効果） \- Es: 立体パラメータ
  ...
  * **1988年** : CoMFA（Comparative Molecular Field Analysis、Cramer et al.）
...
### 産業動向
  ...
  * ✅ AI創薬市場規模（2020年代前半に約$1B → 2030年代前半に$15-25Bと予測。出典により幅があります）
...
**Q4** : ある市場調査の推計では、AI創薬市場は2024年$4.5Bから2030年$25Bに成長すると予測されています（他の推計はこれより低い値です。1.3.1を参照）。この期間のCAGR（年平均成長率）を計算してください。
