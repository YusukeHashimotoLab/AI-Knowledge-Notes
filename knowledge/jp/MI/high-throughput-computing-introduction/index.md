...
chapter_title: ハイスループット計算入門シリーズ
...
### [第3章：ジョブスケジューリングと並列化（SLURM, PBS）](<./chapter-3.html>)

**難易度** : 上級 **読了時間** : 25-30分 **コード例** : 5-6個 
...
### [第4章：データ管理とポストプロセス（FireWorks, AiiDA）](<./chapter-4.html>)

**難易度** : 上級 **読了時間** : 20-25分 **コード例** : 6個 
...
**対象** : DFT計算経験はあるが自動化は初めての方 **期間** : 2週間 **進め方** : 
...
**対象** : 既にDFT自動化経験があり、ワークフロー管理を学びたい方 **期間** : 3-5日 **進め方** : 
...
**対象** : オンプレHPCからクラウド移行を検討している方 **期間** : 1週間 **進め方** : 
