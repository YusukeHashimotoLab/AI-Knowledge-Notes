...
**学習目標:** \- ASEを使った触媒構造の操作と計算 \- 触媒活性予測モデルの構築と評価 \- ベイズ最適化による触媒組成探索 \- DFT計算との統合ワークフロー
...
**評価基準:** \- CO生成選択性 > 80% \- 過電圧 < 0.5 V \- コスト（Ag使用量）最小化

**提出物:** \- 最適組成（Cu:Ag比率） \- 予測活性とコストのトレードオフ分析 \- Pythonコード全体
