---
title: "第4章: 電子-フォノン結合"
chapter_title: "第4章: 電子-フォノン結合"
subtitle: "電子-フォノン相互作用、ポーラロン、超伝導への応用"
---

[🌐 EN](../../../en/MS/phonon-intermediate/chapter-4.md) | 🇯🇵 JP | Last sync: 2025-12-20

[材料科学道場](../index.html) > [フォノン物理学（中級）](index.md) > 第4章

# 第4章: 電子-フォノン結合

**電子-フォノン相互作用、ポーラロン、超伝導への応用**
...
## 目次
  ...
  1. [電子-フォノン相互作用ハミルトニアン](<#section1>)
  2. [フレーリッヒハミルトニアンと変形ポテンシャル](<#section2>)
  3. [ポーラロンの物理](<#section3>)
  4. [電子自己エネルギーと質量繰り込み](<#section4>)
  5. [Eliashberg関数と電子-フォノン結合定数](<#section5>)
  6. [超伝導への応用](<#section6>)
  7. [計算手法とPython実装](<#section7>)
  8. [実験的測定手法](<#section8>)
  9. [まとめ](<#summary>)
  10. [演習問題](<#exercises>)
...
ここで：
  ...
  * \\(u_{\mathbf{q}\nu}\\): フォノンモード\\(\mathbf{q}\nu\\)の変位
    ...
    ```mermaid
    graph TD
                        A[格子振動] -->|変位 u| B[ポテンシャル変化 δV]
                        B --> C[電子状態の変化]
                        C --> D[電子-フォノン結合]
                        D -->|散乱| E[電子遷移]
                        D -->|エネルギー交換| F[フォノン吸収/放出]
                        E --> G[電気抵抗]
                        F --> H[熱伝導]
                        D --> I[超伝導]
...
Eliashberg関数の計算と可視化（Python） コピー
...
[← 第3章: 非調和効果](<chapter-3.html>) [目次へ](<index.html>) [第5章: フォノン輸送 →](<chapter-5.html>)
