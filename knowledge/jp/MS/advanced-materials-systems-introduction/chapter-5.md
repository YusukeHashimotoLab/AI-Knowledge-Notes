---
title: 第5章：Python実践ワークフロー
chapter_title: 第5章：Python実践ワークフロー
subtitle: 先進材料設計の統合解析システム - 高性能化の設計原理
---

🌐 JP | [🇬🇧 EN](<../../../en/MS/advanced-materials-systems-introduction/chapter-5.html>) | Last sync: 2025-11-16
...
第1章では先進セラミックス材料（構造・機能性・バイオセラミックス）の基礎理論を学びました。次の第5章では、Python実践ワークフロー（高性能エンジニアリングプラスチック、機能性高分子、生分解性ポリマー）について学びます。

[← シリーズ目次](<./index.html>) [第5章へ進む →](<./chapter-5.html>)

## 参考文献

  1. Jain, A., et al. (2013). "Commentary: The Materials Project: A materials genome approach to accelerating materials innovation." _APL Materials_ , 1(1), 011002. - Materials Projectの設計思想とデータベース構築方法論
  2. Ward, L., et al. (2018). "Matminer: An open source toolkit for materials data mining." _Computational Materials Science_ , 152, 60-69. - matminerの機械学習特徴量抽出とデータマイニング手法
  3. Ong, S. P., et al. (2013). "Python Materials Genomics (pymatgen): A robust, open-source python library for materials analysis." _Computational Materials Science_ , 68, 314-319. - pymatgenの結晶構造解析と電子状態計算機能
  4. Larsen, A. H., et al. (2017). "The atomic simulation environment—a Python library for working with atoms." _Journal of Physics: Condensed Matter_ , 29(27), 273002. - ASEの原子構造最適化とMDシミュレーション機能
  5. Himanen, L., et al. (2020). "DScribe: Library of descriptors for machine learning in materials science." _Computer Physics Communications_ , 247, 106949. - 材料記述子の計算と機械学習への応用
  6. Pizzi, G., et al. (2016). "AiiDA: automated interactive infrastructure and database for computational science." _Computational Materials Science_ , 111, 218-230. - ハイスループット計算ワークフロー自動化システム
  7. scikit-learn Documentation. (2024). _Machine Learning in Python_. <https://scikit-learn.org/> \- 材料特性予測のための機械学習ライブラリ
